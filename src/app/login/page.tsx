    ...
    <div className="flex min-h-screen items-center justify-center bg-brand-white px-4">
      <div className="w-full max-w-sm flex flex-col gap-8">
        ...
        <div className="flex flex-col gap-4">
          ...
          <button className="mt-1 w-full rounded-xl bg-brand-orange py-3 text-base font-semibold text-white transition-all hover:bg-brand-orange-dark active:scale-95">
            Login
          </button>
        </div>
        ...
        <button className="flex w-full items-center justify-center gap-3 rounded-xl border border-brand-black/15 bg-white py-3 text-sm font-semibold text-brand-black shadow-sm transition-all hover:border-brand-black/30 hover:shadow-md active:scale-95">
